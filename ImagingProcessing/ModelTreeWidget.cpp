...
void ModelTreeWidget::addModelObject(ModelBases *object)
{
    ...
    std::vector<ModelBases::TASK_DATA>& taskDatas = object->getTaskDatas();
    ...
    {
        ModelBases::TASK_DATA data = taskDatas[i];
    ...
    std::vector<ModelBases::TASK_DATA>& systemDatas = object->getSystemDatas();
    ...
    {
        ModelBases::TASK_DATA data = systemDatas[i];
        QTreeWidgetItem* item = new QTreeWidgetItem;
        QString itemName = data.key + "=" + data.value;
        item->setText(0, itemName);
    ...
    std::vector<ModelBases::TASK_DATA>& conditionsDatas = object->getConditionsDatas();
    ...
    {
        ModelBases::TASK_DATA data = conditionsDatas[i];
        QTreeWidgetItem* item = new QTreeWidgetItem;
        QString itemName = data.key + "=" + data.value;
        item->setText(0, itemName);
